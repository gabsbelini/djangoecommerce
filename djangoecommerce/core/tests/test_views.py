...
class LoginViewTestCase(TestCase):
    ...
    def test_login_ok(self):
        response = self.client.get(self.login_url)  # acessa url de login
        self.assertEquals(response.status_code, 200)  # verifica se deu certo (codigo 200)
        self.assertTemplateUsed(response, 'login.html')  # verifica template utilizado
